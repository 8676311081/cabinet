...
import type { AgentProvider, CliProviderInvocation } from "@/lib/agents/provider/provider-interface";
import { providerRegistry } from "@/lib/agents/provider/provider-registry";
import { resolveCliCommand, RUNTIME_PATH } from "@/lib/agents/provider/provider-cli";
import {
